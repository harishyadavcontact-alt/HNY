Hormesis
Natures Biphasic dose response phenomenon where low doses of stressor or toxic agent produce a beneficial or stimulatory effect while higher doses are harmful or inhibitory.

A word coined by pharmacologists, is when a small dose of a harmful substance is actually beneficial for the organism, acting as medicine. A little bit of an otherwise offending substance, not too much, acts to benefit the organism and make it better overall as it triggers some overreaction. This was not interpreted at the time in the sense of “gains from harm” so much as “harm is

- Now consider a case when the poisonous substance, in some dose, makes you better off overall, one step up from robustness.

dose dependent” or “medicine is dose dependent.”

[[Archive/Obsidian-precodex/Library(anti)/State of the Art(Lib)/State of the Art/Philosophers Stone/Anti Fragility/PROTO-ANTIFRAGILITY/Hormesis/Harm form no Harm]]

[[Archive/Obsidian-precodex/Library(anti)/State of the Art(Lib)/State of the Art/Philosophers Stone/Anti Fragility/PROTO-ANTIFRAGILITY/Hormesis/Gains from harm]]

[[Archive/Obsidian-precodex/Library(anti)/State of the Art(Lib)/State of the Art/Philosophers Stone/Anti Fragility/PROTO-ANTIFRAGILITY/Hormesis/Harm is Dose Dependent|Harm is Dose Dependent]]
...
- Hormetic
    ...
    Now these small distractions, like hormetic responses, act up to a point. I haven’t tried it yet, but I am certain that it would be hard to write an essay on
    
    the runway of Heathrow airport.
    

[[Craft/Mastercraft/Intelligence/State of the Art/Philosophers Stone/More is less/Hormetic/It builds character]]

- Over Compensation
    
    - Overcompensation, NAME OF THE GAME
        
        This mechanism of overcompensation hides in the most unlikely places. If tired after an intercontinental flight, go to the gym for some exertion instead of resting. Also, it is a well-known trick that
        
    
    - Overcompensation: we need noise the only way for the signal
        ...
        Consider this remarkable ability humans have to filter out noise at happy hour and distinguish the signal among so many other loud conversations. So not only are we made to overcompensate, but we sometimes _need_ the noise. Like many writers, I like to sit in cafés, working, as they say, against resistance. Consider our bedtime predilection for the rustle of tree leaves or the sound of the ocean: there are even electric contraptions that produce “white noise”3 that helps people sleep better.
...
- Over Drive
    ...
    - If you need something urgently done, give the task to the busiest
        
        (or second busiest) person in the office. Most humans manage to squander their free time, as free time makes them dysfunctional, lazy, and unmotivated—the busier they get, the more active they are at other tasks.
        
    
    - overdrive → extra → opportunistic necessity
        
        . And to return to the drivers of innovation: the additional _quantities_ of motivation and willpower, so to speak, stemming from setbacks can be also seen as extra capacity, no different from extra boxes of victuals.
...
- Overshoot
    ...
    - overkill the name of the game: the right dose
    ...
    [[Craft/Mastercraft/Intelligence/State of the Art/Philosophers Stone/More is less/Hormetic/Get in trouble serious, but not terminal- sophistication is born out of hunger]]
    
    [[Craft/Mastercraft/Intelligence/State of the Art/Philosophers Stone/More is less/Hormetic/detest Comfort]]
    

- Over Reactions
    
    [[Craft/Mastercraft/Intelligence/State of the Art/Philosophers Stone/More is less/Hormetic/“necessity really is the mother of invention.”]]
    
    - Do better under challenging condition than otherwise, bite of more than you can chew
        
        It is said that the best horses lose when they compete with slower ones, and win against better rivals.
        
        Under compensation from the absence of a stressor, inverse hormesis, absence of challenge, degrades the best of the best. In Baudelaire’s poem, “The albatross’s giant wings prevent him from walking”—many do better in Calculus 103 than Calculus 101.
        
    

**Overcompensation and Overreaction, overshoot, Everywhere**

- Overcompensate and Over Shoot: Extra → additional capacity → opportunistically useful
...
- rejection→ obsession → overreaction →overcorrection → antifragile → happy ending
