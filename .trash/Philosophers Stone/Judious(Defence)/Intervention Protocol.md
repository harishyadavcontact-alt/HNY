on when to intervene and when to not

- Controlership
    
    - _What should we control?_
...
[[Archive/Obsidian-precodex/Library(anti)/State of the Art(Lib)/State of the Art/Philosophers Stone/Judious(Defence)/Intervention Protocol/Non-Naive Interventionism]]

[[Archive/Obsidian-precodex/Library(anti)/State of the Art(Lib)/State of the Art/Philosophers Stone/Judious(Defence)/Intervention Protocol/Intervention]]