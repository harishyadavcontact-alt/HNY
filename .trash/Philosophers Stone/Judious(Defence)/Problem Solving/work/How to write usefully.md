...
["A Way to Detect Bias"](https://www.paulgraham.com/bias.html)

after readers pointed out that I'd omitted it. But in practice you can catch nearly all of them.
...
[dead zone](https://www.paulgraham.com/nov.html)

of ideas around it that are relatively unexplored because they contradict it.
...
[Steve Wozniak](http://www.foundersatwork.com/steve-wozniak.html)

did the same thing. In high school he designed computers on paper for fun. He couldn't build them because he couldn't afford the components. But when Intel launched 4K DRAMs in 1975, he was ready.
...
to Trevor Blackwell, Daniel Gackle, Jessica Livingston, and Robert Morris for reading drafts of this.

[[Archive/Obsidian-precodex/Library(anti)/State of the Art(Lib)/State of the Art/Philosophers Stone/Judious(Defence)/Problem Solving/work/How to write usefully/Writing]]