[[Archive/Obsidian-precodex/Library(anti)/State of the Art(Lib)/State of the Art/Philosophers Stone/Judious(Defence)/Rational/Organic Selection]]

[[Archive/Obsidian-precodex/Library(anti)/State of the Art(Lib)/State of the Art/Philosophers Stone/Judious(Defence)/Rational/Ethics]]

[[Archive/Obsidian-precodex/Library(anti)/State of the Art(Lib)/State of the Art/Philosophers Stone/Judious(Defence)/Rational/Prudence]]
...
- Rationality = Natural Selection
    ...
    - The fragile has no option. But the antifragile needs to select what’s best—the best option. It is worth insisting that the most wonderful attribute of nature is the rationality with which it selects its options and picks the best for itself— thanks to the testing process involved in evolution. Unlike the researcher afraid of doing something different, it sees an option—the asymmetry— when there is one.
...
- Rationalis = mistake the cat for a washing machine
    ...
    was the notion of “efficiency”—or optimization.
    

- Rationality ≠ accurate scientific rep or reality but the most useful one
...
- Revelation of Preferences: Skin in the Game
    ...
    1. There is no such thing as “rationality” of a belief, there is rationality of action, They revert to judging beliefs rather than action.
    ...
    - Endless Rationalisation →Thrupatic improved performance
