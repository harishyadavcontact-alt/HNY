- Life is long [[Craft/Mastercraft/Intelligence/State of the Art/Philosophers Stone/Anti Fragility/Volatility/Volatility/Volatility]] it is [[Striving]].
- Life is Volatile, specifically [[Long Volatility]], if it is doing good and [[Short Volatility]] if doing bad.
	- What is alive is antifragile(opp not true): gain from harm to a celing and the celing is going up
...
- Self Healing
	- Self Cureing
	- “similar to the localized self-strengthening that occurs in biological structures.”
	- 
	- Self Repait: adaptable load bearing: Localized Self-strengthening
	- 
	- Inanimate—that is, nonliving—material, typically, when subjected to stress, either undergoes material fatigue or breaks.
	- 
	- One of the rare exceptions I’ve seen is in the report of a 2011 experiment by Brent Carey, a graduate student, in which he shows that composite material of carbon nanotubes arranged in a certain manner produces a self-strengthening response previously unseen in synthetic materials, “similar to the localized self-strengthening that occurs in biological structures.”
	- 
	- This crosses the boundary between the living and the inanimate, as it can lead to the development of adaptable load-bearing material.
		- 
		- 
		- objects don’t self repair
	- 
	...
	- 
- aging: maladjustment & senescence
