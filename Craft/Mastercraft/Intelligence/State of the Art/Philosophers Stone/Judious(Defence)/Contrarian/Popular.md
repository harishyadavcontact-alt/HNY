- Following convention gets applause

- what does everyone agree on, is the convention and it is what receives applause from all audiences can only convential, what we need to understand is the 2 sides of convention, the wisdom of crowds(books, sciences ect ect), the madness of crowd

- Popularity
    
    - Say what everyone agree one, overtly, and you main stream, say what every one agrees, on covertly and you a sub culture, say what majority disagrees on an you are infamous, to be funny, you tride to be what they want to be , be a better virtious man treate everyone the same, femininsm, ect ect by these viticthe keep crashing, or talk and im like not again.[this way they see,racisim, misogyny, ect ect]
...
- Popularity
    ...
    - Humor
        - To be funny, you tried to be what they want to be , be a better virtious man treat everyone the same, femininsm, ect ect by these bitiches keep crashing, or talk and i’m like not again.[this way they see, racisim, misogyny, ect]
- being popular
    ...
    I think the answers to these questions can be found by looking at hackers, and learning what they want. Programming languages are
    
    _for_
    
    hackers, and a programming language is good as a programming language (rather than, say, an exercise in denotational semantics or compiler design) if and only if hackers like it.
    ...
    **4 Hackability**
    ...
    _Let yourself be second guessed._
    ...
    **10 Redesign**
    ...
    To write good software you must simultaneously keep two opposing ideas in your head. You need the young hacker's naive faith in his abilities, and at the same time the veteran's skepticism. You have to be able to think
    ...
    Anything you can do to keep the redesign cycle going is good. Prose can be rewritten over and over until you're happy with it. But software, as a rule, doesn't get redesigned enough. Prose has readers, but software has
    ...
    **11 Lisp**
    ...
    In the matter of libraries I think there is room to beat languages like Perl and Python at their own game. A lot of the new applications that will need to be written in the coming years will be
    
    [server-based applications](https://www.paulgraham.com/road.html)
    ...
    **12 The Dream Language**
    ...
    By way of summary, let's try describing the hacker's dream language. The dream language is
    
    [beautiful](https://www.paulgraham.com/taste.html)
    
    , clean, and terse. It has an interactive toplevel that starts up fast. You can write programs to solve common problems with very little code. Nearly all the code in any program you write is code that's specific to your application. Everything else has been done for you.
    ...
    **Notes**
    ...
    _When the Air Hits Your Brain,_
    
    neurosurgeon Frank Vertosick recounts a conversation in which his chief resident, Gary, talks about the difference between surgeons and internists ("fleas"):
