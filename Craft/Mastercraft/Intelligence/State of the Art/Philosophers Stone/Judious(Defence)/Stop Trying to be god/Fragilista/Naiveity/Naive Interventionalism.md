- **Naïve Interventionism:**
    ...
    Let us call this urge to help “naïve interventionism.”
    
    Naïve Interventionism is the core manifestation of the Fragilista’s error, where top-down attempts to “fix” or control complex systems result in unintended, often severe, and frequently delayed negative consequences, collectively termed **Iatrogenics**.
    

1. Naive Interventionism
    
    1. Intervention with disregard to iatrogenics. The preference, even obligation, to “do something” over doing nothing.
    
    1. While this instinct can be beneficial in emergency rooms or ancestral environments, it hurts in others in which there is an “expert problem.
    

- Iatrogenics: The Path to Hell are Crafted with good Intenctions
    
    - The Invisible Cost: Iatrogenics usually results from the treacherous condition in which the benefits are small and visible, but the costs are very large, delayed, and hidden.
    
    - To sum up, anything in which there is naïve interventionism, nay, even just intervention, will have iatrogenics.
...
- Sale of Commision over omission
    
    - The urge to intervene often comes from the fact that it is easier to sell “Look what I did for you” than “Look what I avoided for you.
    

[[Craft/Mastercraft/Intelligence/State of the Art/Philosophers Stone/Judious(Defence)/Stop Trying to be god/Fragilista/Naiveity/Naive Interventionalism/Manifestations in Complex Systems]]

[[Craft/Mastercraft/Intelligence/State of the Art/Philosophers Stone/Judious(Defence)/Stop Trying to be god/Fragilista/Naiveity/Naive Interventionalism/C. Accountability Failure (The Agency Problem)]]
...
![[/image204.png|image204.png]]

![[/image205.png|image205.png]]