if it works only at scale it works only at cale and will never get thre: path dependence: market is too big
...
- Early adopter: Valubale to the first few users
