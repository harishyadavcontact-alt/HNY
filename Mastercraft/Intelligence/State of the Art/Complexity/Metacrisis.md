- Dept Crisis: Abundance is harder for us to handle than scarcity
    Consider that as I am writing these lines, we are living in a debt crisis. The world as a whole has never been richer, and it has never been more heavily in debt, living off borrowed money. The record shows that, for society, the richer we become, the harder it gets to live within our means.
...
In the 1940s, humanity has gained the ability to self-destruct entirely via nuclear weapons. Other advancing technologies that improve exponentially are AI, synbio, and nanotech. If technological development continues, small groups or even individuals could gain the capacity to devastate all of civilization. Nick Bostrom calls this the [Vulnerable World Hypothesis](https://nickbostrom.com/papers/vulnerable.pdf) in his 2018 working paper.
...
Here are some [examples](https://civilizationemerging.com/new-economics-series-part-iii/) that Daniel Schmachtenberger provides:  
...
![Footprint vs capacity.png](https://www.gameb.wiki/images/5/52/Footprint_vs_capacity.png)

With exponential population growth, many believe our ecological footprint has exceeded the planet's biocapacity. If we do not change our current trajectory, we could be on our way to a [Malthusian catastrophe](https://en.wikipedia.org/wiki/Malthusian_catastrophe), where population growth outpaces agricultural production.

#### We Are Living in a Fragile, Interconnected World

![Civilization lifespans.png](https://www.gameb.wiki/images/thumb/4/42/Civilization_lifespans.png/1000px-Civilization_lifespans.png)

[Here's the full list of the civilisations displayed above.](http://www.bbc.com/future/story/20190218-the-lifespans-of-ancient-civilisations-compared)
...
As [Luke Kemp wrote](https://www.bbc.com/future/article/20190218-are-we-on-the-road-to-civilisation-collapse), there are many reasons why a civilization could collapse, including:
...
- **Red Queen Effect** - [Statistical analysis on empires](https://pdfs.semanticscholar.org/4bbf/b77db6ef43649c998757cf77d9258dabc010.pdf) suggests that collapse is random and independent of age. An explanation is the "Red Queen Effect": if species are continually fighting for survival in a changing environment with numerous competitors, extinction is probable.
- **Complexity** - Collapse expert and historian Joseph Tainter has proposed that societies eventually collapse under the weight of their own accumulated complexity. We describe this in more detail below.![[Pasted image 20260113145237.png]]
- 
