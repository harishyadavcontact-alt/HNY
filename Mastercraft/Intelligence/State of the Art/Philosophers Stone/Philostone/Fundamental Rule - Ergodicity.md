The Fundamental Rule of Reality: Ergodicity

Ergodicity is characterized as the most powerful concept for understanding risk and survival.

• **Ensemble vs. Time Probability:** Ergodicity is violated when the properties of a group at one point in time do not apply to a single individual over time.

• **The Absorbing Barrier:** In real life, "ruin" is an irreversible barrier. If there is even a tiny probability of total ruin, one will eventually reach it given enough time, rendering standard cost-benefit analysis terminally flawed.

• **Rationality as Survival:** Rationality is explicitly redefined as that which allows for survival and avoids ruin.
...
[[Library(anti)/State of the Art(Lib)/State of the Art/Philosophers Stone/Incerto(Lib)/Incerto/Skin in the Game|Skin in the Game]]